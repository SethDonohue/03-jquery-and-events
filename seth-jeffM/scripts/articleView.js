...
articleView.handleMainNav = function() {
  ...
  $('.main-nav').on('click', '.tab', function (e){
    e.preventDefault();
    $('.tab-content').hide();
    console.log('this.data', $(this).data('content'));
...
articleView.setTeasers = function() {
  ...
  $('article').on('click', 'a.read-on', function(e) {
    ...
    // } else {
    //   $('body').animate({ scrollTop: ($(this).parent().offset().top)}, 200);
    //   $(this).html('Read on &rarr;');
    //   $(this).parent().find('.artcile-body *:nth-of-type(n+2)').hide();
    // }
  });
};
